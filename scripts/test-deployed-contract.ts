...
async function main() {
  console.log("🧪 Testing deployed CryptoRaceFHE_Complete contract...");
  ...
  try {
    ...
    // Test funding pool
    await luckyRaceFHE.fundPoolWithETH(0, { value: ethers.parseEther("1.0") });
    console.log("✅ Successfully funded ETH pool");

    // Test configuration
    await luckyRaceFHE.updatePointsConfig(10, 5, 3, 20, 5);
    console.log("✅ Successfully updated points config");

    // Test user actions
    await luckyRaceFHE.connect(user1).buyRaces(3, {
      value: ethers.parseEther("0.03"),
    });
    console.log("✅ User1 successfully bought races");
